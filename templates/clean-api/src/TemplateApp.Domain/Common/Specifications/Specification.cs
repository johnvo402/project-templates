    ...
    where T : class
{
    ...
    internal void SetOrderBy<TKey>(Expression<Func<T, TKey>> orderByExpression)
    {
        OrderBy = orderByExpression;
        OrderByDescending = null;
    }

    internal void SetOrderByDescending<TKey>(Expression<Func<T, TKey>> orderByDescendingExpression)
    {
