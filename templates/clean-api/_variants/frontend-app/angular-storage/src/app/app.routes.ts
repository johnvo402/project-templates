...
export const appRoutes: Routes = [
  ...
  { path: 'products/images', title: 'Product Images', loadComponent: () => import('./features/products/product-images-workspace.component').then(module => module.ProductImagesWorkspaceComponent), canActivate: [permissionGuard], data: { permission: 'products.view' } },
